...
Order_Items
Shipping_Details
**Relationships & Constraints**: Established foreign key relationships to maintain data integrity between products, categories, customers, and orders.
**Data Population**: Inserted realistic sample data across all tables to represent actual e-commerce transactions and customer behavior.
